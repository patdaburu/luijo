...
# -*- coding: utf-8 -*-
#
# luiji documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'luiji.tex', 'luiji Documentation',
     'Pat Daburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'luiji', 'luiji Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'luiji', 'luiji Documentation',
     author, 'luiji', 'One line description of project.',
     'Miscellaneous'),
]
